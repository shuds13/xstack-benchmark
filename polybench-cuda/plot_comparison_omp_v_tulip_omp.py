...
if __name__ == "__main__":
    parser = argparse.ArgumentParser(description="Plot Tulip and Tulip/Noelle speedup relative to OpenMP.")
    parser.add_argument('compiler', type=str, help='Compiler name (e.g., clang, gcc)')
